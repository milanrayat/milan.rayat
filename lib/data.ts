    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "While competing platforms offered screen recording as a standalone capability, Sprinklr's execution was built for how enterprise quality teams actually work. Reviewers stay in one workspace — seeing the screen recording alongside the call transcript, CSAT scores, conversation moments, contact intent signals, and audit history for the same interaction. When a conversation spans multiple channels, such as a voice call that continues over email or chat, the reviewer stays on the same page throughout, with screen recording tied to the relevant channel automatically.",
        ],
      },
      {
        id: 'context',
      ...
      },
      {
        ...
        pills: [
          ...
          },
          {
            ...
            body: 'Enterprise contact centres handle sensitive customer interactions, including calls where personal financial details are discussed or displayed on screen. Any recording system had to enforce strict access boundaries — ensuring that in multi-agent calls, each reviewer could only see recordings of agents within their own reporting structure, not those belonging to other teams or supervisors. This was a compliance requirement, not a configuration option.',
          },
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Customer sessions revealed that quality review is rarely a single-channel activity. A conversation might begin as a voice call, transfer to a different agent, and then continue over chat or email. Each channel transition produced a distinct recording context with its own access rules and display logic. The scenarios multiplied because enterprise workflows multiplied — not because the feature was technically complex in isolation, but because it had to reflect how contact centres actually operate.',
          'A hidden failure mode shaped one of our core requirements early. For voice calls, the screen recording had to be combined with the audio file to produce a single synchronised playback. If that combining step failed without any visible signal to the reviewer, they had no way to know. They would assume no recording existed for that interaction and move on. Silent failures were more damaging than visible ones because they produced no alert and left a gap in quality coverage. This shaped both how we designed failure states and the decision to build a reporting dashboard from day one rather than as a later addition.',
      ...
      },
      {
        ...
        decisions: [
          ...
          },
          {
            ...
            body: 'Many agents work across more than one monitor at a time. We deliberately scoped the first version to single-screen recording only — we needed to prove the full end-to-end flow, from capture through combining to playback, was reliable before adding the complexity of multiple simultaneous screens. Of our 4 initial enterprise customers, 3 operated entirely on single-monitor setups. Single-screen coverage addressed the rollout majority while we validated reliability — a data-backed scoping decision, not a conservative default.',
          },
          {
